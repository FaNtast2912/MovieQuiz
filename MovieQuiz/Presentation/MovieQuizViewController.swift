...
final class MovieQuizViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        // настройка шрифтов так как они отсутствуют в сториборде(
        textLabel.font = UIFont(name: "YSDisplay-Medium", size: 12)
        yesButton.titleLabel?.font = UIFont(name: "YSDisplay-Medium", size: 12)
        noButton.titleLabel?.font = UIFont(name: "YSDisplay-Medium", size: 12)
