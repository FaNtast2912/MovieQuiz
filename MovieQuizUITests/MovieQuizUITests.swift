...
//Я тут на курсе зарядился этим студенческим вайбом и реализовал у себя и еще Калининград присоединился к нам, процесс обучения по ВКС почти как наши воркшопы с наставниками)
